...
The result of multiple group statistic from the above specified whether the 
means of all groups is equal or not. To identify which pairs of groups may 
differ from each other, post-hoc test must be performed.
